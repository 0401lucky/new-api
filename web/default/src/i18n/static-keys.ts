...
export const STATIC_I18N_KEYS = [
  ...
  'Permanent',
  '{{hours}} hours',
  'No blackroom records found',
  'No users are currently in the blackroom.',
  'Search user, reason, or ID...',
  'Add a user to the blackroom immediately.',
  'User ID',
  'Enter user ID',
  'Permanent ban',
  'Keep this user banned until manually released.',
  'Duration hours',
  'Enter duration in hours',
  'Ignored when permanent ban is enabled.',
  'Enter ban reason',
  'User banned successfully',
  'Failed to ban user',
  'Ban user',
  'Configure automatic blackroom scanning and ban defaults.',
  'Enable blackroom',
  'Automatically block users that match risk rules.',
  'Enable auto ban',
  'Run scheduled scans and ban users that match rules.',
  'Lookback hours',
  ...
  'Blackroom settings saved',
  'Failed to save blackroom settings',
  'Release user',
  'This user will be removed from the blackroom immediately.',
  ...
  'Lookback hours must be at least 1',
  'Scan interval must be at least 1 minute',
  'Minimum requests must be zero or greater',
  'Rules are required',
  'Rules must be a valid JSON array',
  'Escalation window must be at least 1 day',
  'Escalation count must be zero or greater',
  'Review and release users blocked by risk rules.',
  ...
  'Failed to delete valid redemption codes',
