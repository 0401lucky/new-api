...
const defaultSecuritySettings: SecuritySettings = {
  ...
  ModelRequestRateLimitConcurrencyCount: 0,
  ...
  SensitiveWords: '',
  PromptCheckMode: 'block',
  PromptCheckThreshold: 50,
  PromptCheckStrictThreshold: 90,
  PromptCheckLogMatchesEnabled: true,
  PromptCheckMaxTextLength: 81920,
  ...
  PromptCheckAPIReviewKey: '',
  PromptCheckAPIReviewTimeoutMS: 3000,
  PromptCheckAPIReviewFailClosedEnabled: false,
