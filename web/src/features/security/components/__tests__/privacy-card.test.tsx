...
describe('privacy settings', () => {
  it('disabling leak protection preserves the IP setting and saves the opt-out', async () => {
    ...
    const toggle = screen.getByRole('switch', { name: 'Leak protection' })
    ...
    expect(put).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        record_ip_log: true,
        disable_leak_protection_balanced: true,
      })
    )
  })
