			...
			if shouldSelectChannel {
				...
				if preferredChannelID, found := service.GetPreferredChannelByAffinity(c, modelRequest.Model, usingGroup); found {
					...
					if err == nil && preferred != nil && preferred.Status == common.ChannelStatusEnabled {
						var mismatchKind taskdto.ChannelFilterKind
						affinitySatisfied, mismatchKind = model.ChannelSatisfiesFilters(preferred, modelRequest.Model, constraints.Filters)
						pathMismatch = mismatchKind == taskdto.FilterRequestPath
					}
