	...
	setDonationRoutes(apiRouter)
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/temporary_quota", controller.GrantUserTemporaryQuota)
		...
		dataRoute.GET("/channel_model_usage", middleware.AdminAuth(), controller.GetChannelModelUsageStats)
		...
		blackroomRoute.Use(middleware.AdminAuth())
		{
			...
			blackroomRoute.GET("/status", controller.GetBlackroomStatus)
			blackroomRoute.GET("/ip-audit", controller.GetBlackroomIPAudit)
			blackroomRoute.GET("/events", controller.GetBlackroomBanEvents)
