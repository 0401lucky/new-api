...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.BlackroomRelayGuard())
	{
	...
	relayGeminiRouter.Use(middleware.BlackroomRelayGuard())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.BlackroomRelayGuard(), middleware.Distribute())
	{
