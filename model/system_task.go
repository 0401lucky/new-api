...
const (
	...
	SystemTaskTypeModelHealthCleanup = "model_health_cleanup"
)
...
type SystemTask struct {
	...
	ActiveKey *string          `json:"active_key,omitempty" gorm:"type:varchar(64);uniqueIndex:uniq_system_tasks_active_key"`
