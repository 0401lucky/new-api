...
// GetDBTimestampTx returns a UNIX timestamp using the given session (or transaction).
// Prefer this inside open transactions so queries reuse the same connection under tight pools.
