...
type TaskPrivateData struct {
	...
	// Wallet funding is persisted for source-aware asynchronous settlement.
	TemporaryQuotaConsumed  int                   `json:"temporary_quota_consumed,omitempty"`
	PermanentQuotaConsumed  int                   `json:"permanent_quota_consumed,omitempty"`
	TemporaryQuotaCheckinId int                   `json:"temporary_quota_checkin_id,omitempty"`
	TemporaryQuotaExpiresAt int64                 `json:"temporary_quota_expires_at,omitempty"`
	TemporaryAllocations    []TemporaryAllocation `json:"temporary_allocations,omitempty"`
