...
const (
	InvitationCodeStatusEnabled  = 1 // don't use 0, 0 is the default value!
	InvitationCodeStatusDisabled = 2 // also don't use 0
	InvitationCodeStatusUsed     = 3 // also don't use 0
)
